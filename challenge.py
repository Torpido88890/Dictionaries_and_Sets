"""Character counter
Your task for this coding exercise is to write some code to count the number of times each character occurs in the given `text` string (see the starter code in exercise.py).
You have to do this for every unique character in the given string. Only count characters and digits - don't include spaces, punctuation or other symbols.
